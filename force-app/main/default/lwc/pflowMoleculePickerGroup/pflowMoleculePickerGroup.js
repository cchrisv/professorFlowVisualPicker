...
const VALID_VARIANTS = new Set([
    VARIANT_GRID, VARIANT_LIST, VARIANT_HORIZONTAL, VARIANT_DROPDOWN, VARIANT_RADIO
]);
...
export default class PflowMoleculePickerGroup extends LightningElement {
    ...
    get isDropdown() { return this.resolvedVariant === VARIANT_DROPDOWN; }
    get isRadio() { return this.resolvedVariant === VARIANT_RADIO; }
    ...
    get decoratedItems() {
        ...
        const maxReached = this.isMulti && this.hasMaxSelections
    ...
    get hasMaxSelections() {
        return this.maxSelections !== undefined && this.maxSelections !== null && this.maxSelections !== '';
    }
    ...
    get groupRole() { return this.isMulti ? 'group' : 'radiogroup'; }
    ...
    get atomVariant() { return this.isList ? VARIANT_LIST : VARIANT_GRID; }
