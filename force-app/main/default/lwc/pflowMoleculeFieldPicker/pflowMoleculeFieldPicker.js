...
import { fetchFields, fieldsToOptions, filterFieldOptions } from 'c/pflowUtilityCpeHelpers';
...
export default class PflowMoleculeFieldPicker extends LightningElement {
    ...
    handleSelectionChange(event) {
        const lu = event.currentTarget;
        const sel = lu && typeof lu.getSelection === 'function' ? lu.getSelection() : null;
    ...
    handleRemovePill(event) {
        const name = (event.currentTarget && event.currentTarget.name) || (event.detail && event.detail.name);
